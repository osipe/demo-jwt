...
import com.example.demoJWT.constants.SecurityConstants;
...
public class JWTAuthenticationFilter extends UsernamePasswordAuthenticationFilter {
	...
	public Authentication attemptAuthentication(HttpServletRequest req, HttpServletResponse res)
		...
		try {
			...
			return authenticationManager.authenticate(new UsernamePasswordAuthenticationToken(creds.getSreenname(),
					creds.getPassword_(), new ArrayList<>()));
		} catch (IOException e) {
